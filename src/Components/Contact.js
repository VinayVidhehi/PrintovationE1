...
const Contact = () => {
  return (
    <div className='main-contact-container'>
       <section className="text-gray-600 body-font relative px-4 bg-zinc-200">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Contact Us</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Put your query here.</p>
          </div>
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a className="text-red-500">siddprints@gmail.com</a>
                <p className="leading-normal my-5">49 Sidd.
                  <br />Kengri, PN 560060
                </p>
